    ...
    async handle(req, res) {
        ...
        try {
            ...
            switch (method.toUpperCase()) {
                case "GET": {
                    ...
                    if (!foundItem) {
                        ...
                        const notFoundBody = notFoundRows[0]?.response_body || { message: "Item not found." };
                        ...
                        if (typeof notFoundBody === "string") {
                            try {
                                ...
                                console.error("❌ JSON parse error for 404 response_body:", err.message);
         ...
         WHERE endpoint_id = $1 AND status_code = 200 LIMIT 1`,
                ...
                default:
                    return res.status(405).json({ error: `Phương thức ${method} chưa hỗ trợ.` });
            }
        } catch (err) {
